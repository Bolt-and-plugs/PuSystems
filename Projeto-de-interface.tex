...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{dist/sign-in.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{dist/sign-up.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{dist/home.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{dist/meu-bairro.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{dist/denunciar-foco.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{dist/monitoramento-de-sintomas.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{dist/modulo-educacional.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{dist/missoes.png}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{dist/splash-screen.png}}
